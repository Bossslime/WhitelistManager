        ...
        for(int i=0; i < 36; i++) {
            switch(i) {
                ...
                case 29: //Multipage Item
                    ...
                    lore.add(Chat.color("&7 "));
                    lore.add(Chat.color("&eWhitelisted"));
                    lore.add(Chat.color("&a>> &eNot Whitelisted &a<<"));
                    lore.add(Chat.color("&7 "));
